...
class RDTLayer(object):
    ...
    def deliver_data(self):
        ...
        #cited https://www.w3schools.com/python/ref_func_sorted.asp
        #empty dataReceived
    ...
    def rdt_send(self):
        ...
        # ########################################################################
        # YOUR CODE HERE:
        #loops through the loop from a range to send multiple packets at once
        for i in range(0, int(self.FLOW_CONTROL_WIN_SIZE/self.DATA_LENGTH)):
            ...
            #compares segment to window size
